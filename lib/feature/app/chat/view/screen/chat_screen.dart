  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            if (widget.otherUser != null || widget.store != null)
              ImageComponent(
                height: 32.r,
                width: 32.r,
                image: widget.store?.avatar ?? widget.otherUser!.avatar ?? '',
              ),
            SizedBox(width: 5.w),
            AppText(
              color: ColorResource.mainFontColor,
              text: widget.store?.name ?? widget.otherUser!.name ?? '',
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Padding(
                                padding: EdgeInsetsDirectional.only(
                                  bottom: 5.h,
                                  start: controller.chatMessages[index].isMine!
                                      ? 0.w
                                      : 50.w,
                                  end: !controller.chatMessages[index].isMine!
                                      ? 0.w
                                      : 50.w,
                                ),
                                child: Row(
                                  mainAxisAlignment:
                                      controller.chatMessages[index].isMine
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          AppText(
                                            text: controller.chatMessages[index]
                                                    .content ??
                                                '',
                                            color: ColorResource.mainFontColor,
                                            textAlign: TextAlign.start,
                                    ...
                                    if (controller
                                        .chatMessages[index].sending.value)

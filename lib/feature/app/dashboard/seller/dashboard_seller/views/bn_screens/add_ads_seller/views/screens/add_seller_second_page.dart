...
class _AddSellerSecondPageState extends State<AddSellerSecondPage> {
  ...
  void selectRow(String key, GeneralModel index) {
    setState(() {
      ...
      print("dgdfgfd ${addAdsSellerController.selectedData[key]}");
    });
  }
        ...
        return Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Row(
                  //list of General Model horizantel
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children:
                      addAdsSellerController.carProperties.gears!.map((e) {
                    return AppSelectableContainer(
                      isSelected:
                          addAdsSellerController.selectedData['gear_id']?.id ==
                              e.id,
            ...
            SingleChildScrollView(
              ...
              child: Row(
                  //list of General Model horizantel
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: addAdsSellerController.carProperties.drivingSides!
                      .map((e) {
                    return AppSelectableContainer(
                      isSelected: addAdsSellerController
                              .selectedData['driving_side_id']?.id ==
                          e.id,
            ...
            Row(
              ...
              children: [
                AppSelectableContainer(
                  isSelected:
                      addAdsSellerController.selectedData['seller_type_id']!.id ==
                          1,
                  onTap: () => selectRow('seller_type_id', GeneralModel(id: 1)),
                ...
                AppSelectableContainer(
                  isSelected:
                      addAdsSellerController.selectedData['seller_type_id']!.id ==
                          2,
                  onTap: () => selectRow("seller_type_id", GeneralModel(id: 2)),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                  //list of General Model horizantel
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: addAdsSellerController
                      .carProperties.technicalAdvantages!
                      .map((e) {
                    return AppSelectableContainer(
                      isSelected: addAdsSellerController
                              .selectedData['technical_advantage_id']?.id ==
                          e.id,
                ...
                Get.bottomSheet(
                    AppBottomSheet(
                      body: BottomSheetBody(
                          ...
                          logo: "",
                          list:
                              addAdsSellerController.carProperties.seats ?? []),
                      height: 500.h,
                    ),
                ...
                Get.bottomSheet(
                    AppBottomSheet(
                      body: BottomSheetBody(
                          ...
                          logo: "",
                          list:
                              addAdsSellerController.carProperties.cylinders ??
                                  []),
                      height: 500.h,
                    ),
                    enterBottomSheetDuration: const Duration(milliseconds: 500),
                ...
                Get.bottomSheet(
                    AppBottomSheet(
                      body: BottomSheetBody(
                          ...
                          logo: "",
                          list:
                              addAdsSellerController.carProperties.doors ?? []),
                      height: 500.h,
                    ),
                    enterBottomSheetDuration: const Duration(milliseconds: 500),
                    exitBottomSheetDuration: const Duration(milliseconds: 400));

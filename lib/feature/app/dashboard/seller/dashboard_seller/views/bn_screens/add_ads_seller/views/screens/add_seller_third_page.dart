      ...
      child: Obx(() {
        return Column(
          children: [
            ...
            AddComponent(
              title: addAdsSellerController.selectedData['category_id']?.name ??
                  context.localizations.vehicle_class,
                ...
                Get.bottomSheet(
                    AppBottomSheet(
                      body: BottomSheetBody(
                          ...
                          list:
                              addAdsSellerController.carProperties.categories ??
                                  []),
                      height: 500.h,
                    ),
            ...
            SizedBox(height: 24.h),
            AddComponent(
              title: addAdsSellerController.selectedData['in_color']?.name ??
                  context.localizations.exterior_color,
            ...
            SizedBox(height: 24.h),
            AddComponent(
              title: addAdsSellerController.selectedData['out_color']?.name ??
                  context.localizations.inner_color,

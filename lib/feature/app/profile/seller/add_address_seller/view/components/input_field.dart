    ...
    return Padding(
      ...
      child: Obx(() {
          return Column(
            ...
            children: [
              AddressComponent(
                title:addAddressSellerController.emira.value!.isNotEmpty?addAddressSellerController.emira.value!:context.localizations.emirate,
              ...
              AddressComponent(
                title: addAddressSellerController.city.value!.isNotEmpty?addAddressSellerController.city.value!: context.localizations.city,
                image: IconsApp.city,
                onPressed: () {
              ...
              SizedBox(height: 15.h),
              AddressComponent(
                title: addAddressSellerController.currentAddress.isNotEmpty?addAddressSellerController.currentAddress.value:context.localizations.location,
